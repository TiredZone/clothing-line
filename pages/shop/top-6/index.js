...
const data = [
    ...
    {
        id: 2,
        src: '/media/images/tissues/cupro.png',
        description: () => <p className="has-text-hdarkred">100% cupro</p>,
    },
];
                            ...
                            <div className="columns">
                                <div className="column is-flex is-justify-content-center">
                                    <figure className="image" style={{ width: '256px', height: '256px' }}>
                                        <img src="/media/images/color-top-6.jpeg" alt="" />
                                    </figure>
                                </div>
                            </div>
                        </div>
...
Top6.getLayout = page => getPageTitleLayout(getMainLayout(page), 'Top 6');
export default Top6;
